...
public class ModuleController {
    ...
    public void init() {
        this.modules.put(1, new Module(1, "Modul Wirtschaftsinformatik", "Beschreibung WIN"));
        this.modules.put(2, new Module(2, "Module Betriebswirtschaftslehre", "Beschreibung BWL"));
        this.modules.put(3, new Module(3, "Module Informatik", "Beschreibung INF"));
        this.modules.put(4, new Module(4, "Module Maschinenbau", "Beschreibung MSB"));
